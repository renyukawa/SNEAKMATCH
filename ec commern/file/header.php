...
<head>
    <meta charset="utf-8">
    <title>SNEAKMATCH | Fashion Store v.1</title>
    <!-- SEO Meta Tags-->
          ...
          <div class="container">
            ...
            <div class="ms-3 text-nowrap"><a class="topbar-link me-4 d-none d-md-inline-block" href="order-tracking.html"><i class="ci-location"></i>Order tracking</a>
              <div class="topbar-text dropdown disable-autohide"><a class="topbar-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><img class="me-2" src="img/flags/en.png" width="20" alt="English">Eng / $</a>
                    ...
                    <li class="dropdown-item p-0">
                      <div class="language-dropdown" style="width:100%">
                        <button type="button" class="lang-btn d-flex align-items-center w-100 px-2 py-1">
                          ...
                          <img class="me-2" src="img/flags/<?php echo $flag; ?>" width="20" alt="<?php echo $alt; ?>"> <span class="lang-label"><?php echo $alt; ?></span>
                  ...
                  /* ensure dropdown inside small menu doesn't overflow horizontally */
                  ...
                  (function(){
                    ...
                    document.addEventListener('click', function(e){
                      ...
                      // persist selection locally (optional)
                      try{ localStorage.setItem('site_currency', cur); }catch(err){}
                      closeCurrency();
                    }, false);
                    // restore label from localStorage on load
              ...
              <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"><span class="navbar-toggler-icon"></span></button><a class="navbar-tool navbar-stuck-toggler" href="#"><span class="navbar-tool-tooltip">Expand menu</span>
                  <div class="navbar-tool-icon-box"><i class="navbar-tool-icon ci-menu"></i></div></a>
                    ...
                    <?php } else { ?>
                    <a class="navbar-tool ms-1 ms-lg-0 me-n1 me-lg-2" href="#signin-modal" data-bs-toggle="modle">
                    <?php } ?>
