...
<head>
  ...
  <title>SNEAKMATCH - Find your footware</title>
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="images/logo (1).png" width="90" height="50" alt="Footcap logo">
      </a>
  ...
  <main>
    <article>
      ...
      <section class="section hero" style="background-image: url('images/cover.png')">
        <div class="container">
      ...
      <section class="section collection">
        <div class="container">
          ...
          <ul class="collection-list has-scrollbar">
            ...
            <li>
              <div class="collection-card" style="background-image: url('images/men.jpg')">
            ...
            <li>
              <div class="collection-card" style="background-image: url('images/women.jpg')">
            ...
            <li>
              <div class="collection-card" style="background-image: url('images/sport.jpg')">
      ...
      <section class="section product">
        <div class="container">
          ...
          <ul class="filter-list">
            ...
            <li>
              <button class="filter-btn">TIGER</button>
            </li>

            <li>
              <button class="filter-btn">LV</button>
            </li>
          ...
          <ul class="product-list">
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/rn1.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/leather.jpg" width="312" height="350" loading="lazy"
                    alt="Leather Mens Shoes" class="image-contain">
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/fabric.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/aj1.png" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/aj.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/puma.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/travis1.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/LV.jpg" width="312" height="350" loading="lazy"
                    alt="Simple Fabric Shoe" class="image-contain">
      ...
      <section class="section cta">
        <div class="container">
          ...
          <ul class="cta-list">
            ...
            <li>
              <div class="cta-card" style="background-image: url('images/sale.jpg')">
            ...
            <li>
              <div class="cta-card" style="background-image: url('images/nike1.jpg')">
      ...
      <section class="section special">
        <div class="container">
          ...
          <div class="special-banner" style="background-image: url('images/nike1.jpg')">
      ...
      <div class="container">
        ...
        <div class="footer-link-box">
          ...
          <ul class="footer-list">
            ...
            <li>
              <a href="tel:+54544556" class="footer-link">
                <ion-icon name="call"></ion-icon>

                <span class="footer-link-text">+5579899556</span>
              </a>
            </li>
            ...
            <li>
              <a href="mailto:footcap@help.com" class="footer-link">
                ...
                <span class="footer-link-text">......@help.com</span>
              </a>
            </li>
